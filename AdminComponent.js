    ...
    {admin1 && (
      <Container style={{ height: '100vh' }}>
        <Card sx={{ width: 600, margin: 'auto' }}>
          ...
          />
          <CardContent>
            <Typography variant="body1"><strong>Nom:</strong> {admin1.nom}</Typography>
          ...
          <div>
            ...
            {selectedQuiz && selectedQuiz.questions && (
              <Modal show={true} onHide={() => setSelectedQuiz(null)}>
                ...
                <Modal.Body className="modal-body-scrollable" style={{ maxHeight: 'calc(100vh - 200px)', overflowY: 'auto' }}>
                  <form>
